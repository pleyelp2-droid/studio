...
"[project]/src/ai/flows/data:944223 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/axiomatic-engine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const generateProceduralPOIs = function(count) {
    let minDistance = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 30;
    const pois = [];
    const types = [
        'MINE',
        'FOREST',
    ...
    for(let i = 0; i < count; i++){
        ...
        pois.push({
            id: "poi_".concat(Date.now(), "_").concat(i),
            type,
            position: [
                x,
                0,
...
const calculateCombatHeuristics = (agent, nearbyMonsters)=>{
    ...
    return {
        targetId: target.id,
        action: 'ATTACK',
        reason: "Greife ".concat(target.name, " an.")
    };
};
const calculateAxiomaticWeightWithReason = function(agent, action, nearbyAgents, nearbyResources) {
    let nearbyPOIs = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [], nearbyMonsters = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : [];
    ...
    var _agent_thinkingMatrix_sociability;
    const sociability = (_agent_thinkingMatrix_sociability = agent.thinkingMatrix.sociability) !== null && _agent_thinkingMatrix_sociability !== void 0 ? _agent_thinkingMatrix_sociability : 0.5;
    var _agent_thinkingMatrix_aggression;
    const aggression = (_agent_thinkingMatrix_aggression = agent.thinkingMatrix.aggression) !== null && _agent_thinkingMatrix_aggression !== void 0 ? _agent_thinkingMatrix_aggression : 0.5;
    var _agent_thinkingMatrix_curiosity;
    const curiosity = (_agent_thinkingMatrix_curiosity = agent.thinkingMatrix.curiosity) !== null && _agent_thinkingMatrix_curiosity !== void 0 ? _agent_thinkingMatrix_curiosity : 0.5;
    var _agent_thinkingMatrix_frugality;
    const frugality = (_agent_thinkingMatrix_frugality = agent.thinkingMatrix.frugality) !== null && _agent_thinkingMatrix_frugality !== void 0 ? _agent_thinkingMatrix_frugality : 0.5;
    let baseUtility = 0;
    ...
    switch(action){
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].BANKING:
            if (invCount >= 8) {
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].EXPLORING:
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].GATHERING:
            if (invCount >= 10) {
                baseUtility = -100;
            } else {
                let resourceScore = 0;
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].CRAFTING:
            const canCraft = bankCount > 5 || invCount > 5;
            if (canCraft) {
                var _agent_skills_smithing, _agent_skills, _agent_skills_crafting, _agent_skills1;
                const goalBonus = checkGoal("craft") || checkGoal("produce") ? 1.4 : 1.0;
                baseUtility = (100 + (((_agent_skills = agent.skills) === null || _agent_skills === void 0 ? void 0 : (_agent_skills_smithing = _agent_skills['smithing']) === null || _agent_skills_smithing === void 0 ? void 0 : _agent_skills_smithing.level) || ((_agent_skills1 = agent.skills) === null || _agent_skills1 === void 0 ? void 0 : (_agent_skills_crafting = _agent_skills1['crafting']) === null || _agent_skills_crafting === void 0 ? void 0 : _agent_skills_crafting.level) || 1) * 10) * goalBonus;
                reason = "Materialien für Produktion vorhanden.";
            }
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].QUESTING:
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].THINKING:
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].ASCENDING:
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].COMBAT:
            if (nearbyMonsters.length > 0) {
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].TRADING:
            const nearbyTraders = nearbyAgents.filter((a)=>a.id !== agent.id && a.state === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].MARKETING);
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].ALLIANCE_FORMING:
            ...
            break;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].IDLE:
...
const summarizeNeurologicChoice = function(agent, nearbyAgents, nearbyResources) {
    let nearbyPOIs = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : [], nearbyMonsters = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [];
    const choices = [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].IDLE,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].GATHERING,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].EXPLORING,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].QUESTING,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].THINKING,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].BUILDING,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].BANKING,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].CRAFTING,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentState"].COMBAT
    ];
    ...
    const logic = "[AUE]: ".concat(best.choice, " Reason: ").concat(best.reason);
    return {
        ...best,
        logic
    };
...
const generateLoot = (monsterType)=>{
    ...
    return {
        id: "item-".concat(Date.now(), "-").concat(Math.random()),
        name: "".concat(rarity, " ").concat(type),
        type,
        subtype: 'LOOT',
        rarity,
        stats,
        value: Math.floor(10 * multiplier),
        description: "A ".concat(rarity, " item dropped from a ").concat(monsterType, ".")
    };
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$944223__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:944223 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$a53d19__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:a53d19 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$92f7ca__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:92f7ca [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$be87d9__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:be87d9 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiomatic$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/axiomatic-engine.ts [app-client] (ecmascript)");
'use client';
;
;
;
 ...
 */ function getLocalHeuristicDecision(agent, nearbyAgents, nearbyNodes) {
    const local = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiomatic$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["summarizeNeurologicChoice"])(agent, nearbyAgents, nearbyNodes, [], []);
    return {
...
const AIService = {
    async generateDecision (agent, nearbyAgents, nearbyNodes, logs) {
        ...
        try {
            var _agent_thinkingMatrix, _agent_thinkingMatrix1;
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$944223__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["autonomousDecisionFlow"])({
                agentName: agent.displayName,
                currentState: agent.state,
                hp: agent.hp,
                consciousnessLevel: agent.consciousnessLevel || 1.0,
                awakeningProgress: agent.awakeningProgress || 0,
                longTermGoal: ((_agent_thinkingMatrix = agent.thinkingMatrix) === null || _agent_thinkingMatrix === void 0 ? void 0 : _agent_thinkingMatrix.currentLongTermGoal) || 'Survive',
                personality: ((_agent_thinkingMatrix1 = agent.thinkingMatrix) === null || _agent_thinkingMatrix1 === void 0 ? void 0 : _agent_thinkingMatrix1.personality) || 'Neutral',
                relationships: {},
    ...
    async generateEmergentAction (agent, nearby, logs) {
        ...
        try {
            var _agent_thinkingMatrix, _agent_thinkingMatrix1;
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$a53d19__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["emergentBehaviorFlow"])({
                agentName: agent.displayName,
                personality: ((_agent_thinkingMatrix = agent.thinkingMatrix) === null || _agent_thinkingMatrix === void 0 ? void 0 : _agent_thinkingMatrix.personality) || 'Neutral',
                economicDesires: {
                    targetGold: 1000,
                    greedLevel: ((_agent_thinkingMatrix1 = agent.thinkingMatrix) === null || _agent_thinkingMatrix1 === void 0 ? void 0 : _agent_thinkingMatrix1.aggression) || 0.5,
                    riskAppetite: 0.5,
                    frugality: 0.5,
                    marketRole: 'TRADER',
                    tradeFrequency: 0.5
    ...
    async importAgent (source, type) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$92f7ca__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["importAgentFlow"])({
            source,
            type
        });
    },
    async diagnose (context, logs) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$be87d9__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["projectDiagnosticsFlow"])({
            context,
            errorLog: logs
        });
    }
...
"[project]/src/services/TransactionWrapper.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const { firestore: db } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initializeFirebase"])();
async function withFirestoreTransaction(fn) {
    if (!db) {
        throw new Error('Simulation disconnected: Firestore not available.');
    }
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runTransaction"])(db, async (transaction)=>{
...
"[project]/src/services/AgentManager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.esm2017.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/firebase/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$TransactionWrapper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/TransactionWrapper.ts [app-client] (ecmascript)");
'use client';
;
;
;
...
async function syncAgentsBatch(agents) {
    if (!db) return;
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$TransactionWrapper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withFirestoreTransaction"])(async (transaction)=>{
        for (const agent of agents){
            const agentRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, 'players', agent.id);
...
async function initializePilot(uid, name) {
    if (!db) return;
    const agentRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, 'players', uid);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(agentRef, {
        id: uid,
        displayName: name,
...
"[project]/src/components/game/SimulationManager.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AgentManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/AgentManager.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/firebase/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/provider.tsx [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
...
const SimulationManager = ()=>{
    ...
    const { agents, addLog, userApiKey } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    // Social Interaction Loop (Every 15s)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SimulationManager.useEffect": ()=>{
            const interval = setInterval({
                "SimulationManager.useEffect.interval": ()=>{
                    const activeAgents = agents.filter({
                        "SimulationManager.useEffect.interval.activeAgents": (a)=>a.hp > 0
                    }["SimulationManager.useEffect.interval.activeAgents"]);
                    if (activeAgents.length > 1) {
                        const a1 = activeAgents[Math.floor(Math.random() * activeAgents.length)];
                        const a2 = activeAgents.find({
                            "SimulationManager.useEffect.interval.a2": (a)=>a.id !== a1.id
                        }["SimulationManager.useEffect.interval.a2"]);
                        if (a2) {
                            addLog("Neural Resonance: ".concat(a1.displayName, " acknowledge ").concat(a2.displayName, "."), 'SYSTEM');
                        }
                    }
                }
            }["SimulationManager.useEffect.interval"], 15000);
            return ({
                "SimulationManager.useEffect": ()=>clearInterval(interval)
            })["SimulationManager.useEffect"];
        }
    }["SimulationManager.useEffect"], [
        agents,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SimulationManager.useEffect": ()=>{
            const interval = setInterval({
                "SimulationManager.useEffect.interval": async ()=>{
                    if (!userApiKey) return;
                    const activeAgents = agents.filter({
                        "SimulationManager.useEffect.interval.activeAgents": (a)=>a.npcClass !== 'SYSTEM'
                    }["SimulationManager.useEffect.interval.activeAgents"]);
                    if (activeAgents.length > 0) {
                        const agent = activeAgents[Math.floor(Math.random() * activeAgents.length)];
                        try {
                            const behavior = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AIService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIService"].generateEmergentAction(agent, activeAgents, []);
                            addLog("[EMERGENT] ".concat(agent.displayName, ": ").concat(behavior.action), 'SYSTEM');
                        } catch (e) {
                            console.error('Emergent behavior fail', e);
                        }
                    }
                }
            }["SimulationManager.useEffect.interval"], 30000);
            return ({
                "SimulationManager.useEffect": ()=>clearInterval(interval)
            })["SimulationManager.useEffect"];
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SimulationManager.useEffect": ()=>{
            const interval = setInterval({
                "SimulationManager.useEffect.interval": async ()=>{
                    if (agents.length > 0) {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AgentManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["syncAgentsBatch"])(agents);
                        addLog('Deterministic state committed to neural ledger.', 'SYSTEM');
                    }
                }
            }["SimulationManager.useEffect.interval"], 60000);
            return ({
                "SimulationManager.useEffect": ()=>clearInterval(interval)
            })["SimulationManager.useEffect"];
        }
...
_s(SimulationManager, "/aniEmQ1SGdB5O96agEyVmrA8Ys=", false, function() {
    return [
...
_c = SimulationManager;
var _c;
__turbopack_context__.k.register(_c, "SimulationManager");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/firebase/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$client$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/client-provider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$game$2f$SimulationManager$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/game/SimulationManager.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AIService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/AIService.ts [app-client] (ecmascript)");
;
...
function RootLayout(param) {
    let { children } = param;
    _s();
    const addLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])({
        "RootLayout.useStore[addLog]": (state)=>state.addLog
    }["RootLayout.useStore[addLog]"]);
    // Global Error Listener for "Matrix Corruption"
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RootLayout.useEffect": ()=>{
            const handleError = {
                "RootLayout.useEffect.handleError": (event)=>{
                    var _event_error;
                    console.error("Matrix Corruption Detected:", event.error);
                    addLog("Corruption: ".concat(event.message), 'ERROR');
                    // Trigger deep diagnostics if possible
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AIService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIService"].diagnose('RUNTIME_ERROR', (_event_error = event.error) === null || _event_error === void 0 ? void 0 : _event_error.stack);
                }
            }["RootLayout.useEffect.handleError"];
            window.addEventListener('error', handleError);
            return ({
                "RootLayout.useEffect": ()=>window.removeEventListener('error', handleError)
            })["RootLayout.useEffect"];
        }
    }["RootLayout.useEffect"], [
        addLog
...
_s(RootLayout, "+5TAdnUW1Eg52aIcTbM1mH7Fa10=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
});
...
//# sourceMappingURL=src_f01732f0._.js.map