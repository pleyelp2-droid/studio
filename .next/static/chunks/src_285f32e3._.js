...
class WorldBuildingService {
   ...
   */ static generateAxiomaticContent(chunk) {
        ...
        if (isSanctuary) {
            ...
            for(let k = 1; k <= 3; k++){
                pois.push({
                    id: "city-tree".concat(k, "-").concat(chunk.id),
                    type: 'TREE',
                    position: [
            ...
            for(let i = 0; i < 8; i++){
                for(let j = 0; j < 8; j++){
                    ...
                    if (dataVal > 0.6 && Math.random() < 0.25) {
                        pois.push({
                            id: "bldg-".concat(chunk.id, "-").concat(i, "-").concat(j),
                            type: 'BUILDING',
                            position: [
                                posX,
                                0,
            ...
            for(let j = 0; j < 8; j++){
                ...
                if (dataVal > 0.8 && magnitude < 0.08) {
                    pois.push({
                        ...
                        discoveryRadius: 15,
                        rewardInsight: 10,
                        loreFragment: "Axiomatic Resonance detected at ".concat(chunk.id, "."),
                        threatLevel: 0.1
                    });
                }
                ...
                if (magnitude > 0.06 && Math.random() < 0.05) {
                    pois.push({
                        id: "dungeon-".concat(chunk.id, "-").concat(i, "-").concat(j),
...
_s1(LocalPlayerController, "WJyCo7go+mSFAIIgtS8s+zmhDXA=", false, function() {
    return [
...
_s3(Terrain, "FxuhbcGS1ZfUCNYqmP4h2b5q1/c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$5a94e5eb$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__C__as__useThree$3e$__["useThree"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$5a94e5eb$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"]
    ];
...
_s(WorldPreviewPage, "sn8dZ5Ka/n451at9YoHmOQ6oTdA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirestore"],
...
//# sourceMappingURL=src_285f32e3._.js.map