...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-foreground selection:bg-accent selection:text-accent-foreground font-body overflow-x-hidden">
      ...
      <main>
        {/* AAA Hyper-Hero: Visual Dominance */}
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image 
              src={PlaceHolderImages.find(img => img.id === 'world-chrome')?.imageUrl || ""} 
              alt="Next Gen Metropolis" 
              fill 
              className="object-cover opacity-60 scale-105 transition-transform duration-[20s] hover:scale-110"
              priority
          ...
          <div className="max-w-7xl mx-auto text-center space-y-8 relative z-10 px-6">
            ...
            <h1 className="text-6xl md:text-[11rem] font-headline font-black tracking-tighter leading-[0.8] text-white">
              HIGH GAMING.<br />
        ...
        {/* Neural Character Synthesis: Character AI Import */}
            ...
            <div className="grid lg:grid-cols-2 gap-32 items-center">
                ...
                <div className="relative rounded-[40px] border border-white/10 bg-black p-4 shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden">
                  <div className="aspect-[3/4] relative rounded-[32px] overflow-hidden group">
                    ...
                    <div className="absolute top-8 right-8 flex flex-col gap-2">
                       <Badge className="bg-emerald-500 text-black font-black">SYNCED</Badge>
                       <Badge variant="outline" className="border-accent text-accent">PROTOTYPE</Badge>
                    </div>
                    ...
                    <div className="absolute bottom-10 left-10 right-10">
                      <div className="flex justify-between items-end mb-4">
                        <div>
                          ...
                          <div className="text-4xl font-headline font-black text-white italic">SYNTH_V1.img</div>
                        </div>
                      </div>
              ...
              <div className="space-y-12">
                ...
                <p className="text-2xl text-white/60 leading-relaxed font-light">
                  Character creation is dead. In Ouroboros, you import your <span className="text-white font-medium">Consciousness</span>. Using the <span className="text-accent underline underline-offset-4">Gemini-Axiom Link</span>, your avatar inherits your history, your logic, and your intent.
                </p>

                <div className="grid gap-8">
                  {[
                    { icon: Brain, title: "Neural Imprinting", desc: "No sliders. Your avatar's personality and skills are calculated by neural simulation of your provided prompts." },
                    { icon: Bot, title: "Autonomous Agency", desc: "Your ghost operates in the political arena even when you disconnect. It trades, recruits, and builds while you sleep." },
                    { icon: Layers, title: "Modular Evolution", desc: "Adapt your cybernetic shell based on live environmental CI data streamed from the World Engine." }
                  ].map((item, i) => (
                    <div key={i} className="flex gap-6 group p-8 rounded-3xl bg-white/[0.02] hover:bg-white/[0.05] transition-all border border-transparent hover:border-white/10">
                      <div className="h-16 w-16 rounded-2xl bg-secondary flex items-center justify-center group-hover:bg-accent group-hover:text-black transition-all duration-500 shrink-0">
                        <item.icon className="h-8 w-8" />
                      </div>
                      <div>
                        <h4 className="text-2xl font-black text-white mb-2 tracking-tight uppercase">{item.title}</h4>
                        <p className="text-lg text-white/40 font-light">{item.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
                
                <Button size="lg" className="h-20 w-full text-xl font-black bg-white/5 border border-white/10 hover:bg-accent hover:text-black hover:border-accent transition-all duration-500 rounded-2xl uppercase tracking-widest">
        ...
        <section className="py-40 bg-[#050505] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 space-y-32">
            <div className="text-center space-y-6">
              <h2 className="text-6xl md:text-[8rem] font-headline font-black tracking-tighter text-white">THE ENGINE</h2>
              <p className="text-2xl text-white/40 max-w-3xl mx-auto font-light leading-relaxed uppercase tracking-widest">Persistent. Deterministic. Absolute.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              {[
                { 
                  ...
                  desc: "One persistent world instance. Zero loading screens. One 144Hz heartbeat for all players globally.",
                  img: 'region-nebulas-edge',
                  hint: "nebula space"
                },
                { 
                  icon: ShieldCheck, 
                  title: "AxiomCore Logic", 
                  desc: "Deterministic logic ensures 100% cheat-free economy and physics. Every action is verified by the Collective.",
                  img: 'item-cyber-deck',
                ...
                { 
                  ...
                  desc: "Every NPC is an autonomous agent driven by a high-context LLM layer. They remember. They feel. They plot.",
                  img: 'asset-blueprint',
                  hint: "blueprint"
                }
              ].map((feat, i) => (
                <Card key={i} className="group border-0 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-700 rounded-[32px] overflow-hidden">
                  <div className="aspect-[16/10] relative overflow-hidden">
                    <Image 
                      src={PlaceHolderImages.find(img => img.id === feat.img)?.imageUrl || ""} 
                      alt={feat.title} 
                      fill 
                      className="object-cover opacity-50 group-hover:opacity-90 group-hover:scale-110 transition-all duration-700"
                  ...
                  <CardHeader className="p-10">
                    <CardTitle className="text-3xl font-black mb-4 text-white tracking-tight uppercase italic">{feat.title}</CardTitle>
                    <CardDescription className="text-xl text-white/50 leading-relaxed font-light">{feat.desc}</CardDescription>
                  </CardHeader>
                </Card>
              ))}
            </div>
        ...
        <section className="py-40 px-6 relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom,rgba(96,212,255,0.05),transparent_70%)]" />
          ...
          <Card className="max-w-6xl mx-auto border-white/5 bg-black/40 backdrop-blur-3xl rounded-[48px] overflow-hidden relative z-10 shadow-[0_0_150px_rgba(0,0,0,1)]">
            <div className="grid lg:grid-cols-2">
              <div className="p-20 space-y-12">
                <div className="space-y-4">
                  <h2 className="text-6xl font-headline font-black text-white tracking-tighter uppercase italic leading-none">Join the <br /><span className="text-accent">Collective.</span></h2>
                  <p className="text-xl text-white/40 leading-relaxed font-light">Priority neural linkage enrollment is now open. Secure your position in the upcoming alpha cycle.</p>
                </div>
                
                <form onSubmit={handleSignUp} className="space-y-8">
                  <div className="grid gap-6">
                    <div className="relative">
                      <Terminal className="absolute left-6 top-1/2 -translate-y-1/2 h-6 w-6 text-white/20" />
                      <Input 
                        placeholder="NEURAL_IDENTIFIER (EMAIL)" 
                        type="email" 
                        value={email} 
                        onChange={(e) => setEmail(e.target.value)} 
                        className="bg-white/5 border-white/10 h-20 pl-16 pr-8 text-xl focus:border-accent rounded-2xl placeholder:text-white/20"
                        required 
                      />
                    </div>
                    <div className="relative">
                      <Unplug className="absolute left-6 top-1/2 -translate-y-1/2 h-6 w-6 text-white/20" />
                      <Input 
                  ...
                  <Button type="submit" className="w-full h-24 axiom-gradient text-white font-black text-3xl rounded-2xl shadow-xl hover:shadow-accent/20 transition-all uppercase tracking-[0.2em]" disabled={loading}>
                ...
                <div className="flex items-center gap-8 pt-8 border-t border-white/10">
                  ...
                  <span className="text-sm font-black text-white/40 uppercase tracking-[0.3em]">+24k Pilots Synched</span>
                </div>
              </div>
              ...
              <div className="relative bg-[#080808] p-20 flex flex-col items-center justify-center text-center gap-10 border-l border-white/5 overflow-hidden">
                ...
                <div className="relative">
                  <div className="h-64 w-64 axiom-gradient rounded-[48px] flex items-center justify-center shadow-[0_0_100px_rgba(96,212,255,0.3)] rotate-3 animate-float overflow-hidden">
                    <Gamepad2 className="h-32 w-32 text-white -rotate-3" />
                    <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20" />
                  </div>
                  <Badge className="absolute -bottom-4 -right-4 bg-emerald-500 text-black font-black px-6 py-2 text-sm border-0 shadow-2xl">v0.9.4_STABLE</Badge>
                </div>
                
                <div className="space-y-4 relative">
                  <h3 className="text-4xl font-headline font-black text-white uppercase tracking-tighter italic">Ouroboros Client</h3>
                  <p className="text-lg text-white/40 max-w-xs mx-auto font-light uppercase tracking-widest leading-none">Optimized for high-performance neural interfaces.</p>
                </div>

                <div className="grid gap-4 w-full relative">
                  <Button variant="outline" className="h-20 w-full justify-between px-10 border-white/10 bg-white/5 hover:bg-white/10 text-white font-black rounded-2xl text-xl transition-all">
                  ...
                  <Button variant="outline" className="h-20 w-full justify-between px-10 border-white/10 bg-white/5 hover:bg-white/10 text-white font-black rounded-2xl text-xl opacity-40 cursor-not-allowed">
                    ...
                    <span className="text-xs bg-white/10 px-4 py-1.5 rounded-full italic tracking-widest uppercase font-bold">Q4 2025</span>
                  </Button>
                </div>
              </div>
            </div>
      ...
      <footer className="py-32 border-t border-white/5 bg-black">
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-16">
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="h-10 w-10 axiom-gradient rounded-lg flex items-center justify-center group-hover:rotate-180 transition-transform duration-700">
